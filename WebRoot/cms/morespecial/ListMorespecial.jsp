...
<body leftmargin="8" topmargin="8" background='${ctx}/static/img/allbg.gif'>
	<form id="queryForm" name='form0' action='' method='get'>
		<input type="hidden" id="orderColumn" name="orderColumn" value="$!{morespecial.orderColumn}" />
		<table width='98%'  border='0' cellpadding='1' cellspacing='1' bgcolor='#cfcfcf' align="center" style="margin-top:8px">
  			<tr bgcolor='#EEF4EA'>
    			<td>
      				<table border='0' cellpadding='0' cellspacing='0' height="32">
        				<tr class="search">
        					<td>专题名称：<input type='text' name='specialNames' value='$!{MorespecialInfo.specialNames}'/></td>
        					<td>状态：
									<select name="status" id="status">
                                     		<option value="">==请选择==</option>
    										<option value="0" #if(${MorespecialInfo.status} == '0') selected="selected" #end >禁用</option>
    										<option value="1" #if(${MorespecialInfo.status} == '1') selected="selected" #end >启用</option>
	       							</select>
        					</td>
		...
		<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CFCFCF" align="center" style="margin-top:8px">
			<tr bgcolor="#EEF4EA" >
				<td height="28" colspan="9"  style="padding-left:10px;">专题管理</td>
			</tr>
			<tr align="center" bgcolor="#FBFCE2" height="25">
				<td><a href="javascript:void(0);" name="specialnames" lastOrderBy="$!orderColumn" class="tb_head">专题名称</a></td>
				<td><a href="javascript:void(0);" name="identify" lastOrderBy="$!orderColumn" class="tb_head" >图片标识</a></td>
				<td><a href="javascript:void(0);" name="name" onclick="orderBy(this);" lastOrderBy="$!orderColumn"class="tb_head">关联影片</a></td>
				<td>操作</td>
			</tr>
